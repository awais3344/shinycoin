...
static unsigned char pchMessageStartTest[4] = { 0xe0, 0xd2, 0x88, 0xa1 };

// ShinyCoin message start
static unsigned char pchMessageStartShinyCoin[4] = { 0xa8, 0xfd, 0x8a, 0xf2 };
...
void GetMessageStart(unsigned char pchMessageStart[])
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, pchMessageStartShinyCoin, sizeof(pchMessageStartShinyCoin));
}
