...
const std::string CSyncCheckpoint::strMasterPubKey = "046e08372d0edc8dff793f6a548ab55de46edb6224d00bee354576c5459c569bc332c7486638cf9f154e661d414c0c6f76da1e0022a5253b079cf5e7378b144fb1";
...
namespace Checkpoints
{
    ...
    bool ValidateSyncCheckpoint(uint256 hashCheckpoint)
    {
        ...
        if (pindexCheckpointRecv->nHeight <= pindexSyncCheckpoint->nHeight)
        {
            ...
            if (pindex->GetBlockIDHash() != hashCheckpoint)
            {
        ...
        if (pindex->GetBlockIDHash() != hashSyncCheckpoint)
        {
            hashInvalidCheckpoint = hashCheckpoint;
    ...
    bool CheckSync(const uint256& hashBlock, const CBlockIndex* pindexPrev)
    {
        ...
        if (nHeight > pindexSync->nHeight)
        {
            ...
            if (pindex->nHeight < pindexSync->nHeight || pindex->GetBlockIDHash() != hashSyncCheckpoint)
